...
// Fetch data
$sql = "SELECT * FROM booking WHERE service = 'yoga'";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM messages WHERE service = 'yoga'";
...
<body>
    ...
    <div class="pageNameSection">
      <h1>Client activity in yoga</h1>
    </div>

    <h2 style="text-align: center;">Booking details of clients from yoga</h2>
  ...
  <table>
    ...
    <h2 style="text-align: center;">Message of clients from yoga</h2>
