...
<body>
      ...
      <div class="container">
        ...
        <nav class="nav">
          <ul class="nav-links">
            ...
            <li><a href="admin_loginDetails.php">Login details</a></li>
          </ul>
    ...
    <h2 style="text-align: center;">Booking details of clients</h2>
  ...
  <table>
    ...
    <h2 style="text-align: center;">Message details of clients</h2>
