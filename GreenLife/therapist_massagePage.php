...
// Fetch data
$sql = "SELECT * FROM booking WHERE service = 'massage'";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM messages WHERE service = 'massage'";
...
<body>
    ...
    <div class="pageNameSection">
      <h1>Client activity in massage</h1>
    </div>

    <h2 style="text-align: center;">Booking details of clients for massage therapy</h2>
  ...
  <table>
    ...
    <h2 style="text-align: center;">Message from massage thereapy clients</h2>
