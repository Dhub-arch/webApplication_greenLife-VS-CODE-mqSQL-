...
// Fetch data
$sql = "SELECT * FROM booking WHERE service = 'ayurweda'";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM messages WHERE service = 'ayurweda'";
...
<body>
    ...
    <div class="pageNameSection">
      <h1>Client activity in Ayurweda therapy</h1>
    </div>

    <h2 style="text-align: center;">Booking details of clients from Ayurweda</h2>
  ...
  <table>
    ...
    <h2 style="text-align: center;">Message of clients from Ayurweda</h2>
