...
// Fetch data
$sql = "SELECT * FROM booking WHERE service = 'physiotherapy'";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM messages WHERE service = 'physiotherapy'";
...
<body>
    ...
    <div class="pageNameSection">
      <h1>Client activity in physiotherapy</h1>
    </div>

    <h2 style="text-align: center;">Booking details of clients for physiotherapy</h2>
  ...
  <table>
    ...
    <h2 style="text-align: center;">Message details of clients from physiotherapy</h2>
