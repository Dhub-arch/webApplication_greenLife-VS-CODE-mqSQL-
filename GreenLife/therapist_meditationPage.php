...
// Fetch data
$sql = "SELECT * FROM booking WHERE service = 'meditation'";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM messages WHERE service = 'meditation'";
...
<body>
    ...
    <div class="pageNameSection">
      <h1>Client activity in meditation</h1>
    </div>

   <h2 style="text-align: center;">Booking details of clients for meditation programe</h2>
  ...
  <table>
    ...
    <h2 style="text-align: center;">Message details of clients from meditation programe</h2>
